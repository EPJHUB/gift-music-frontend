...
const PlayIcon = () => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <g clipPath="url(#clip0_5711_1392)">
        <path
...
const AddIcon = () => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <g clipPath="url(#clip0_4027_1533)">
        <path
...
export { PlaylistIcon, FilterIcon, SearchIcon, PlayIcon, AddIcon, PlayIconAlt, LogoutIcon };
